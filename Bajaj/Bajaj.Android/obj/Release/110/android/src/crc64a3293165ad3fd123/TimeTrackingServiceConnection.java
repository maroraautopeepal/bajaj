...
public class TimeTrackingServiceConnection
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Bajaj.Droid.Dependencies.TimeTrackingServiceConnection, SML.Android", TimeTrackingServiceConnection.class, __md_methods);
	}


	public TimeTrackingServiceConnection ()
	{
		super ();
		if (getClass () == TimeTrackingServiceConnection.class)
			mono.android.TypeManager.Activate ("Bajaj.Droid.Dependencies.TimeTrackingServiceConnection, SML.Android", "", this, new java.lang.Object[] {  });
	}
