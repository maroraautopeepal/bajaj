...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Hoho.Android.UsbSerial.Extensions.UsbSerialPortInfo, Android.UsbSerial", UsbSerialPortInfo.class, __md_methods);
	}
	...
	public UsbSerialPortInfo ()
	{
		...
		if (getClass () == UsbSerialPortInfo.class)
			mono.android.TypeManager.Activate ("Hoho.Android.UsbSerial.Extensions.UsbSerialPortInfo, Android.UsbSerial", "", this, new java.lang.Object[] {  });
	}
	...
	public UsbSerialPortInfo (android.os.Parcel p0)
	{
		super ();
		if (getClass () == UsbSerialPortInfo.class)
			mono.android.TypeManager.Activate ("Hoho.Android.UsbSerial.Extensions.UsbSerialPortInfo, Android.UsbSerial", "Android.OS.Parcel, Mono.Android", this, new java.lang.Object[] { p0 });
	}
